...
public static class ItemCatalog
{
    ...
    [
        ...
        new("steel-saber", "Steel Saber", EquipmentSlot.Weapon, new StatMods(Attack: 10, CritPercent: 2), 2_500),
        new("arkforged-edge", "Arkforged Edge", EquipmentSlot.Weapon, new StatMods(Attack: 18, Magic: 6, CritPercent: 4), 10_000),
        // Armor
        new("padded-vest", "Padded Vest", EquipmentSlot.Armor, new StatMods(MaxHp: 20, Defense: 3), 500),
        new("chain-hauberk", "Chain Hauberk", EquipmentSlot.Armor, new StatMods(MaxHp: 45, Defense: 8), 2_500),
